  ...
  <div class="col-md-10 pl-5 res mb-5 mt-3">
    <form @submit.prevent="createPost">
      <div class="mt-4 bg-8 pt-3 pl-5 pr-5">
        <h6 class="color-main font-weight-bold">THÊM MỚI BÁO CÁO HÀNG HOÁ</h6>
        <div class="mt-3">
          <table class="table table-borderless">
            <tbody>
              <tr>
                ...
                <td style="width: 15%">Tên hàng</td>
                <td>
                  <select v-if="post.salon_id"
                    class="inputx mr-3 res-margin-0"
                    id="cars salon"
                    style="width: 100%; outline: none"
                    required
                  ...
                  <div v-else class="inputx text-left">---Chọn tên sản phẩm---</div>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <input
                    ...
                    style="width: 100%"
                    required
                    v-model="post.export_cancel"
                  />
                </td>
                 <td>Số lượng xuất khác</td>
                <td>
                  <input
                    type="number"
                    placeholder="số lượng"
...
export default {
  ...
  methods: {
    ...
    // tao moi san pham
    createPost() {
      HTTP.post(`/salon/main/manage/reportGoods/store`, this.post).then(
        (res) => {
          let result = res.data;
          console.log(result);
          if (result.status === 1) {
