      ...
      <div class="bg-16 p-3 mb-4">
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-borderless">
              <tbody>
                <tr>
                  <td class="font-weight-bold text-right">Tên combo:</td>
                  <td colspan="2">
                    <input
                      type="text"
                ...
                <tr>
                  <td class="font-weight-bold text-right">Mã combo:</td>
                  <td colspan="2">
                    <input
                      type="text"
...
export default {
  ...
  methods: {
    detailCombo() {
      ...
      HTTP.get("/salon/main/manage/marketing/3/" + this.idCombo).then((res) => {
        let result = res.data;
        if (result.status === 1) {
    ...
    updateCombo() {
      ...
      HTTP.put(
        `/salon/main/manage/marketing/3/${this.idCombo}/update`,
