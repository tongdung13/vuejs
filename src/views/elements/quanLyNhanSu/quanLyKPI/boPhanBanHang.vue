              ...
              <div class="row p-2">
                ...
                <div class="col-md-8 col-sm-8 col-8 text-left p-0">
                  ...
                  <span v-if="target.orders" class="color-main">
                    {{ formatNumber(target.orders) + " Đơn" }}
                  </span>
                  <span v-else class="color-main">
                    Chưa có mục tiêu
                  </span>
              ...
              <div class="row p-2">
                ...
                <div class="col-md-8 col-sm-8 col-8 text-left p-0">
                  ...
                  <span v-if="target.serving_quantity" class="color-main">
                    {{ formatNumber(target.serving_quantity) }} Khách
                  </span>
                  <span v-else class="color-main">
                    Chưa có mục tiêu
                  </span>
              ...
              <div class="row p-2">
                ...
                <div class="col-md-8 col-sm-8 col-8 text-left p-0">
                  ...
                  <span v-if="target.customers_numbers" class="color-main">
                    {{ formatNumber(target.customers_numbers) }} Đơn
                  </span>
                  <span v-else class="color-main">
                    Chưa có mục tiêu
                  </span>
              ...
              <div class="row p-2">
                ...
                <div class="col-md-8 col-sm-8 col-8 text-left p-0">
                  ...
                  <span v-if="target.new_customers_numbers" class="color-main">
                    {{ formatNumber(target.new_customers_numbers) }} khách
                  </span>
                  <span v-else class="color-main">
                    Chưa có mục tiêu
                  </span>
          ...
          >
            <thead>
              <tr>
                ...
                <th style="width: 10%" class="text-center">Mục tiêu</th>
                <th style="width: 15%;" class="text-center">Đạt được</th>
                <th style="width: 40%" class="text-center">Tiến độ</th>
...
export default {
  ...
  methods: {
    getList() {
      HTTP.get(
        `/salon/main/manage/kpi?position=3&target_type=${this.target_type}`
      )
        .then((res) => {
          let result = res.data;
          if (result.status === 1) {
